...
<title>exercicio18CapitalPeriodotaxa</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet" >
</head>
<body> 
<div class="container py-3">
<h1>exercicio18CapitalPeriodotaxa</h1>
<form method="post">
<div class="mb-3">
...
$taxa = $_POST['taxa'];       // taxa em %
$periodo = $_POST['periodo']; // tempo

$montante = $capital * pow(1 + ($taxa / 100), $periodo);
$juro = $montante - $capital;

echo "Juros compostos: R$ " . number_format($juro, 2, ',', '.');
?>
